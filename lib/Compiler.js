...
class Compiler {
	...
	run(callback) {
		...
		const run = () => {
			console.log("hook beforeRun called");
			this.hooks.beforeRun.callAsync(this, err => {
				if (err) return finalCallback(err);
				console.log("hook run called");
...
${other}`);
	...
	newCompilation(params) {
		...
		console.log("hook thisCompilation called");
		this.hooks.thisCompilation.call(compilation, params);
		console.log("hook compilation called");
	...
	compile(callback) {
		...
		console.log("hook beforeCompile called");
		this.hooks.beforeCompile.callAsync(params, err => {
			if (err) return callback(err);
			console.log("hook compile called");
			...
			this.hooks.make.callAsync(compilation, err => {
				console.log("hook make called");
				logger.timeEnd("make hook");
				if (err) return callback(err);

				logger.time("finish make hook");
				this.hooks.finishMake.callAsync(compilation, err => {
					console.log("hook finishMake called");
					...
					process.nextTick(() => {
						...
						compilation.finish(err => {
							...
							compilation.seal(err => {
								...
								console.log("hook afterCompile called");
