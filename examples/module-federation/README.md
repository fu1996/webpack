...
app:
  ...
  app (webpack 5.60.0) compiled successfully
...
mfe-b:
  ...
  mfe-b (webpack 5.60.0) compiled successfully
...
mfe-c:
  ...
  mfe-c (webpack 5.60.0) compiled successfully
```
...
app:
  ...
  asset app.js 7.67 KiB [emitted] [minimized] (name: app)
...
mfe-b:
  asset vendors-node_modules_date-fns_esm_index_js.js 83.2 KiB [emitted] [minimized] (id hint: vendors)
  asset node_modules_react_index_js.js 6.94 KiB [emitted] [minimized] 1 related asset
  asset mfeBBB.js 5.83 KiB [emitted] [minimized] (name: mfeBBB)
...
mfe-c:
  asset vendors-node_modules_date-fns_esm_index_js.js 83.2 KiB [emitted] [minimized] (id hint: vendors)
  asset mfeCCC.js 6.48 KiB [emitted] [minimized] (name: mfeCCC)
